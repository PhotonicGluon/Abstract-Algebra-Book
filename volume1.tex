...
%=========== Global Variables ============
\newcommand{\version}{0.18}
\newcommand{\volumenumber}{1}
\newcommand{\volumename}{Groups}
\newcommand{\volumeimage}{icosahedron.png}

%============== Resources ================
\externaldocument{volume0/algebra}
...
\include{volume1/intro-to-groups}
\include{volume1/basics-of-groups}
\include{volume1/subgroups}
\include{volume1/homomorphisms-and-isomorphisms}
\include{volume1/symmetry-groups}
\include{volume1/products}
\include{volume1/further-homomorphisms}
\include{volume1/more-groups}
\include{volume1/group-actions}
\include{volume1/sylow-theorems}
\include{volume1/composition-series}
\include{volume1/simple-groups}

\appendix
\include{volume1/exercise-solutions}
\include{volume1/problem-solutions}
\include{volume1/appendices}
