...
- Fixed a minor formatting issue with a citation in the bibliography.
- Added cover stuff.

### Part 0 (Preliminaries) Changes
- Moved remark that used to be after example 1.3.2 to be after definition 1.3.1.
- Edited problem 1.3, replacing "cardinality is finite" with "set is finite".
...
- Amend a small error in the description of example 5.3.3.
...
- Made explaining the signum function into a new definition (definition 14.3.11).
- Qualified proposition 14.4.8.
- Rewritten the introduction to chapter 15 (Group Actions).
- Rewritten example 15.1.3 to be more explicit.
