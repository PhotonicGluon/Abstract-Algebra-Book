...
We end this section by looking at a result regarding normal extensions.
...
\begin{theorem}\label{thrm-equivalence-of-finite-normal-separable-extensions}
    Let $F$ be a field and $E/F$ be a field extension. Then the following statements are equivalent.
    \begin{enumerate}
        \item $E$ is a finite, normal, separable extension of $F$.
...
\begin{proof}[Proof (see {\cite[Theorem 23.19]{judson_beezer_2022}})]
    ...
    \begin{itemize}
        ...
        Hence any irreducible polynomial $f(x)$ separates in $E$, and has all its zeroes in $E$, proving that $E$ is separable and normal.
    \end{itemize}
