...
%TODO: Replace with another exercise; move this to polynomial rings (somewhere?)
\begin{exercise}
...
%         R = \left\{\begin{pmatrix}a&b\\0&c\end{pmatrix}\vert a,b,c\in\Z\right\}.
%     \]
%     Let $\phi: R \to \Z, \begin{pmatrix}a&b\\0&c\end{pmatrix} \mapsto a+c$. Is $\phi$ a ring homomorphism?
% \end{exercise}
