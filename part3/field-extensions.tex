...
We note \myref{thrm-simple-extension-isomorphism} shows that an element of $F(\alpha)$ takes the form $a_0+a_1\alpha + \cdots + a_{n-1}\alpha^{n-1}$. Since this is, in fact, a unique representation, therefore, using the language of vector spaces, the set
\[
