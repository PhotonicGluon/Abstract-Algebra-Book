...
\begin{definition}
    Let $F$ be a field, $E/F$ be a field extension, and $\alpha \in E$ be algebraic over $F$. The monic polynomial $p(x) \in F[x]$ of minimal degree which $\alpha$ is a root of is called the \textbf{minimal polynomial for $\alpha$ over $F$}\index{extension!algebraic!minimal polynomial}.
\end{definition}
