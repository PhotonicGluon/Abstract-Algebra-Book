...
\begin{questions}
    ...
    \item We prove this by induction on $n$. The base case of $n = 1$ is the Freshman's Dream (\myref{prop-freshman-dream}). Assume that the statement holds for some positive integer $k$, i.e. $(x+y)^{p^k} = x^{p^k} + y^{p^k}$. Note that
    \begin{align*}
