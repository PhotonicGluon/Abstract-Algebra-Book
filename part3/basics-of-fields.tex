...
\begin{definition}
    Let $K$ be a subset of a field $F$. Then $K$ is said to be a \textbf{subfield}\index{subfield} of $F$ if $K$ is also a field under the same operations as $F$.
\end{definition}
...
\begin{proof}
    ...
    If instead $n = 0$, consider the map $\phi: \Q \to K$ such that $\frac ab \mapsto (a1)(b1)^{-1}$. We just need to show that $\phi$ is a well-defined surjective homomorphism, as we can use \myref{thrm-homomorphism-from-field-is-injective-or-trivial} to quickly conclude that it is also an isomorphism.
    ...
    \end{itemize}
    Therefore, by \myref{thrm-homomorphism-from-field-is-injective-or-trivial}, we see that $\phi$ is a isomorphism, meaning $K \cong \Q$.
\end{proof}
