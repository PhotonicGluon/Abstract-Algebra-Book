...
- Fixed confusing argument in the proofs of theorems I.4.5.2 and I.4.5.3
- Changed wording of the procedure to create the cycle decomposition/notation of a permutation to be clearer in section I.5.1
...
- Fixed incorrect statement that the kernel is the subgroup of the codomain (when, in reality, it is a subgroup of the domain) in section I.7.2
