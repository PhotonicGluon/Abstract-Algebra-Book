...
- Made truth tables in section 2.2 be on one line.
...
- Added more terms to the index.
- Rewritten the axioms in section 4.1 to be more concise.
...
- Fixed minor typo in the statement of problem 4.7(i).
...
- Fixed wrong group in the proof of proposition 14.3.13.
...
- Fixed slight error in  the proof of lemma 17.3.2, and make it clearer.
- Made the description of $D_6$ in example 18.3.3 be consistent with other instances of the dihedral group.
...
- Added extra detail about the classification of finite simple groups.
- Made other minor changes to the text.
...
- Added more detail to example 22.2.6 and example 22.2.7 on divisibility notation.
...
- Rewritten definition 27.4.1 to be clearer.
