...
\newtheorem{conjecture}[theoremhidden]{Conjecture}
\newtheorem{proposition}[theoremhidden]{Proposition}
\newtheorem{lemma}[theoremhidden]{Lemma}
\newtheorem{corollary}[theoremhidden]{Corollary}
...
{\definecolor{shadecolor}{named}{PaleGreen}\begin{shaded}\noindent\begin{theoremhidden}}
{\end{theoremhidden}\end{shaded}}

\newenvironment{definition}
{\definecolor{shadecolor}{named}{LightCyan}\begin{shaded}\noindent\begin{definitionhidden}}
