...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Chapter 20 motivates the definition of rings, and provides the axioms for rings.
        \item Chapter 21 builds on chapter 20 by defining more terms and properties found within rings.
        \item Chapter 22 focuses on a specific type of rings; readers should be familiar with the terminology and results from chapter 21.
        ...
        \item Chapter 27 assumes familiarity with all content in ring theory (chapters 20 to 26), since many connections that are established within chapter 27 will only be evident after reading previous chapters.
