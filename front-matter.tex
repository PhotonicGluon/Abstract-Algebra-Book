...
\newcommand{\volumefullname}{A Complete Introduction to Abstract Algebra -- \volumetitle}
...
\begin{titlepage}
    ...
    \AddToShipoutPictureBG*{%
        \AtPageLowerLeft{%
            \includegraphics[width=\paperwidth,height=\paperheight]{images/cover/cover.png}%
        }%
    }
    ...
    \begin{center}
        ...
        {\fontsize{16pt}{0pt}\selectfont \volumetitle}\\
        {\fontsize{14pt}{0pt}\selectfont Version \version}\\
        
        % \vspace{1.25cm}
        \vspace{0.75cm}  % Used temporarily, remove once we don't use the volume title any more
