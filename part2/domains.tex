...
\begin{proof}
    ...
    For multiplication, \myref{exercise-multiplication-over-field-of-fractions-is-well-defined} (later) proves that multiplication is well-defined.
\end{proof}

\begin{proposition}
    Let $D$ be an integral domain. $\Frac{D}$ as given in \myref{definition-field-of-fractions} is indeed a field.
\end{proposition}
\begin{proof}
    % TODO: Add
\end{proof}

\begin{exercise}\label{exercise-multiplication-over-field-of-fractions-is-well-defined}
    Prove that multiplication over the field of fractions is a well-defined operation.
\end{exercise}
