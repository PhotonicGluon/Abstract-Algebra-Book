...
\section{What are (Integral) Domains?}
\begin{definition}
...
\end{definition}
\begin{remark}
    This is similar to how the integers do not have multiplicative inverses in general, hence the name of ``integral domain''.
\end{remark}
...
\begin{proposition}[Cancellation Law for Domains]\index{domain!ring!cancellation law}\label{prop-domain-cancellation-law}
