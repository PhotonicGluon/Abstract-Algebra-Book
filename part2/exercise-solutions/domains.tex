...
\begin{questions}
    ...
    \item Since $\Z$ is a PID (\myref{prop-Z-is-PID}), therefore $\Z$ is a UFD (\myref{thrm-PID-is-UFD}) which shows that $\Z[x]$ is a UFD (\myref{thrm-UFD-iff-polynomial-ring-is-UFD}).
