...
\begin{questions}
    ...
    Suppose $i,j\in I\cap J$, so $i,j \in I$ and $i,j \in J$. Note $I$ and $J$ are ideals and so are subrings, which means that $i-j \in I$ and $i-j \in J$, which hence means $i-j \in I\cap J$, satisfying the first statement for the test for ideals.
