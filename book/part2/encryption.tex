...
An implementation of NTRU, as described in this chapter, is available on GitHub at \url{https://github.com/PhotonicGluon/Abstract-Algebra-Book} under the \code{misc} folder.
