...
\begin{definition}
    A \term{semigroup}\index{semigroup} is a set $S$ together with an operation $\ast$ satisfying the \term{semigroup axioms}\index{axiom!semigroup} as follows.
    \begin{itemize}
...
\begin{definition}
    A \term{ring}\index{ring} is a set $R$ with two binary operations $+$ and $\cdot$ satisfying the following \term{ring axioms}\index{axiom!ring}.
    \begin{itemize}
