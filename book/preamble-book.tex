...
%=============== Geometry ================
\makeatletter
% 7in x 10in is executive paper size
\Ifstr{\isebook}{true}{
    % eBook geometry
    \geometry{papersize={7.25in, 10.25in}, layoutsize={7in, 10in}, inner=2cm, outer=2cm, top=2.5cm, bottom=2cm}
}{
    % Normal paper geometry
    \geometry{papersize={7.25in, 10.25in}, layoutsize={7in, 10in}, inner=2.5cm, outer=1.5cm, top=2.5cm, bottom=2cm}
}
