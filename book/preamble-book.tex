...
\Ifstr{\isebook}{true}{
    % eBook geometry
    \geometry{papersize={17.6cm, 25cm}, layoutsize={17.6cm, 25cm}, inner=2cm, outer=2cm, top=2.5cm, bottom=2cm}
}{
    % Normal paper geometry
    \geometry{papersize={7.25in, 10.25in}, layoutsize={17.6cm, 25cm}, inner=2.5cm, outer=1.5cm, top=2.5cm, bottom=2cm}
}
