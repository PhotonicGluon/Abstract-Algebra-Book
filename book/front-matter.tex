...
\begin{itemize}
    ...
    \begin{itemize}
        \item An exercise can be thought of as a simple ``self-review'' question. Exercises ensure that the content of a particular section is understood, and is related to the content of the current section.
        \item A problem is a more holistic version of an exercise. Generally, solutions to problems require a thorough understanding of the chapter and may require results from other chapters.
    \end{itemize}
    Full solutions to all questions are included. Note that these are just suggested answers; other approaches may be valid.
