...
\begin{proof}[Proof (see {\cite[Theorem 21.5]{gallian_2016}})]
    Let $[K:E] = m$ and $[E:F] = n$. In addition let $X = \{\mathbf{x}_1, \mathbf{x}_2, \dots, \mathbf{x}_m\}$ be a basis for $K$ over $E$, and $Y = \{\mathbf{y}_1, \mathbf{y}_2, \dots, \mathbf{y}_n\}$ be a basis for $E$ over $F$. It suffices to prove that
    \[
