...
\begin{definition}
    Two lines are \term{parallel}\index{line!parallel} to each other when, produced indefinitely in both directions, they do not meet one another in either direction.
\end{definition}
