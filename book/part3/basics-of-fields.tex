...
\end{proposition}
\begin{proof}
    Since the intersection of subfields of a field is itself a subfield (\myref{prop-intersection-of-subfields-is-subfield}), the intersection of all the subfields of the field is also a subfield.
\end{proof}
