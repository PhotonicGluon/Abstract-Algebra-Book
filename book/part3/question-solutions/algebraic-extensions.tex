...
\begin{questions}
    ...
    \]
    Since $p$ is a prime we must have either $[E:F(\alpha)] = 1$ or $[F(\alpha):F] = 1$, meaning $E = F(\alpha)$ or $F(\alpha) = F$ by \myref{prop-finite-extension-of-degree-1-means-extension-equals-base-field}.
    ...
    \item \begin{partquestions}{\roman*}
        ...
        \[
            [F(a_0, \dots, a_n, \alpha):F] = \underbrace{[F(a_0, \dots, a_n, \alpha):F(a_0, \dots, a_n)]}_{\text{At most } n}\underbrace{[F(a_0, \dots, a_n):F]}_{\text{Finite}}
        \]
