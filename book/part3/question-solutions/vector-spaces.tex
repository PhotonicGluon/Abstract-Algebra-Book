...
\begin{questions}
    ...
    \end{itemize}
    Therefore, by subspace test (\myref{thrm-subspace-test}), we see $V$ is a subspace of $F[x]$ over $F$, meaning that $V$ is a vector space over $F$.
    ...
    \item \begin{partquestions}{\alph*}
        ...
        \item Note a basis as $U$ is not linearly independent (from \myref{exercise-polynomial-of-degree-at-most-2-vector-space}).
    \end{partquestions}
