\setpartpreamble[u][\textwidth]{
    ...
    Unlike the other parts, not all results will have a proof; most of these results are outside the scope of abstract algebra, and their proofs can be easily found online. We only prove some results there, especially if the result is hard to prove or find a proof online.
}
\part{Preliminaries}
