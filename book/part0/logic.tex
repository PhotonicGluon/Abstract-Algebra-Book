...
\begin{definition}
    A \term{tautology}\index{tautology} is a statement form that is always true, and we denote it by \textbf{true}.
\end{definition}

\begin{definition}
    A \term{contradiction}\index{contradiction} is a statement form that is always false, and we denote it by \textbf{false}.
\end{definition}
...
\begin{definition}
    ...
    \end{itemize}
    Any $x \in D$ for which $P(x)$ is false is called a \term{counterexample}\index{counterexample}.
\end{definition}
