...
We end this section by looking at intervals.
\begin{definition}
...
\begin{example}
    The set of integers has infinite elements, so $|\Z| = \infty$.
\end{example}
...
\begin{problem}
    ...
    \end{align*}
    Find the cardinality of the following sets. If the set is finite, list all elements of the set.
    \begin{partquestions}{\alph*}
        \item $A \cap B$
        \item $A \cup B$
    \end{partquestions}
