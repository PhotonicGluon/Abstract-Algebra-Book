...
\begin{problem}
    ...
    \]
    For example, for two distinct zeroes, $D = \alpha_1 - \alpha_2$. For three distinct zeroes, $D = (\alpha_1-\alpha_2)(\alpha_1-\alpha_3)(\alpha_2-\alpha_3)$. The \term{discriminant}\index{discriminant}\index{polynomial!discriminant} of $f(x)$ is defined to be $\Delta = D^2$.
    \begin{partquestions}{\roman*}
