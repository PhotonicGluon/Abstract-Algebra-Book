...
\begin{itemize}
    \item The \textbf{Baby Monster group}\index{Baby Monster group}, usually denoted $\mathrm{B}$, has order
    \begin{align*}
    ...
    \end{align*}
    \item The \textbf{Monster group}\index{Monster group}, usually denoted $\mathrm{M}$, has order
    \begin{align*}
