...
\end{definition}
\begin{remark}
    Some authors (e.g. {\cite[Definition 4.2.0]{libretexts_im-and-ker}}) will use $\phi(G)$ to denote the image of $\phi$. The alternate notation $\mathrm{Im}\;\phi$ may also be used (e.g. by {\cite[Definition I.2.2]{hungerford_1980}} and \cite[\S 66]{clark_1984}).
\end{remark}
...
\begin{remark}
    Some authors (e.g. {\cite[Definition 4.2.0]{libretexts_im-and-ker}}) will use $\phi^{-1}(e_H)$ to denote the kernel of $\phi$. The alternate notation $\mathrm{Ker}\;\phi$ may also be used by some authors (e.g. by {\cite[Definition I.2.2]{hungerford_1980}} and \cite[\S 65]{clark_1984}).
\end{remark}
...
We are now ready to tackle important theorems regarding homomorphisms. We first state the Fundamental Homomorphism Theorem, which is also sometimes called the First Isomorphism Theorem (e.g. in {\cite[p.~251, Theorem 3]{cohn_1982}}).
...
We now prove the Fundamental Homomorphism Theorem.
...
We now look at the next theorem, called the Diamond Isomorphism Theorem (e.g. in {\cite[Theorem 3.18]{dummit_foote_2004}}) or the Second Isomorphism Theorem (e.g. in {\cite[\S 69]{clark_1984}}).
...
\begin{example}
    ...
    Consider the groups $G = \Z$, $H = m\Z$, and $N = n\Z$ under addition. By the Diamond Isomorphism Theorem (\myref{thrm-isomorphism-2}),
    \[
