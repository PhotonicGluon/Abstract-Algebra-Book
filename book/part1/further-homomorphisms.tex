...
\begin{definition}
    The \term{image}\index{homomorphism!image} (or \term{range}\index{homomorphism!range}) of a homomorphism $\phi: G \to H$ is the set
    \[
...
\begin{definition}
    The \term{kernel}\index{homomorphism!kernel} of a homomorphism $\phi: G \to H$ is the set of elements in the group $G$ which map to the identity in the group $H$. That is, if the identity of $H$ is $e_H$, then the kernel of $\phi$ is the set
    \[
