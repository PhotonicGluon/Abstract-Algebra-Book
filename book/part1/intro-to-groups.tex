...
This property can be called the \term{axiom of closure} and can be written like this:
\begin{quote}
...
So what is a group?
\begin{definition}
    A \term{group}\index{group} is a set $G$ together with a operation on $G$, here denoted by $\ast$, satisfying the following axioms.
    \begin{itemize}
