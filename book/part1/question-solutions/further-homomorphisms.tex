...
\begin{questions}
    ...
    \item Note $G / \ker \phi \cong \im \phi$ by the Fundamental Homomorphism Theorem (\myref{thrm-isomorphism-1}). Furthermore, we know that $|G / \ker \phi| = \frac{|G|}{|\ker\phi|}$ by Lagrange's theorem (\myref{thrm-lagrange}). Hence, $\frac{|G|}{|\ker\phi|} = |\im\phi|$ which leads to the result quickly.
