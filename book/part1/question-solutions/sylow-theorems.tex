...
\begin{questions}
    ...
    Now consider the group $PH$. Since 5 and 133 are coprime, thus $P \cap H = \{e\}$. In addition, since $P \lhd G$ thus $PH \leq G$ by Second Isomorphism Theorem (\myref{thrm-isomorphism-2}), statement 3. Also,
    \[
