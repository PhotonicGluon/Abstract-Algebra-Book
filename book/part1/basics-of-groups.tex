...
\begin{example}
    The symmetries of the regular pentagon is given by the group $D_5$.
\end{example}
\begin{figure}[h]
    \centering
    \pdfteximgframed[12pt]{0.3\textwidth}{part1/images/basics-of-groups/symmetries-of-pentagon.pdf_tex}
    \caption{Symmetries of a Regular Pentagon}
\end{figure}
