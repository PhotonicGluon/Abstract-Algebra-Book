...
\begin{definition}
    Let $G$ be a group and $S$ be a non-empty subset of $G$. The \term{normalizer of $S$ in $G$}\index{normalizer} is given by
    \[
...
The Third Sylow Theorem gives us a way to determine how many Sylow $p$-subgroups of a certain order exist within a group. This theorem is very useful in determining the structure of finite groups, and can help us reason our way through the properties that a finite group of a fixed order must have.
