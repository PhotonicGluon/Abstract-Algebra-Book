...
Before we continue with the core result of this chapter, we look at Zassenhaus' lemma, which is sometimes called the Fourth Isomorphism Theorem\index{isomorphism theorem!group!fourth}. The proof of this lemma is fairly technical, but we try to include as much detail as necessary to clarify difficult parts of the proof.
...
\end{definition}
\begin{example}
    We previously found two subnormal series of $D_4$, namely
    \[
        1 \lhd \{e, r^2\} \lhd D_4
    \]
    and
