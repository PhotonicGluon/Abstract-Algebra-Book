...
\begin{example}
    ...
    \begin{table}[h]
        ...
        \resizebox{\textwidth}{!}{
            ...
            \hline
            $\mathbf{\times}$ & \textbf{1} & \textbf{2} & \textbf{i} & \textbf{1+i} & \textbf{2+i} & \textbf{2i} & \textbf{1+2i} & \textbf{2+2i} \\ \hline
            \textbf{1}    & 1      & 2      & $i$    & $1+i$  & $2+i$  & $2i$   & $1+2i$ & $2+2i$ \\ \hline
            \textbf{2}    & 2      & 1      & $2i$   & $2+2i$ & $1+2i$ & $i$    & $2+i$  & $1+i$  \\ \hline
            \textbf{i}    & $i$    & $2i$   & 2      & $2+i$  & $2+2i$ & 1      & $1+i$  & $1+2i$ \\ \hline
            \textbf{1+i}  & $1+i$  & $2+2i$ & $2+i$  & $2i$   & 1      & $1+2i$ & 2      & $i$    \\ \hline
            \textbf{2+i}  & $2+i$  & $1+2i$ & $2+2i$ & 1      & $i$    & $1+i$  & $2i$   & 2      \\ \hline
            \textbf{2i}   & $2i$   & $i$    & 1      & $1+2i$ & $1+i$  & 2      & $2+2i$ & $2+i$  \\ \hline
            \textbf{1+2i} & $1+2i$ & $2+i$  & $1+i$  & 2      & $2i$   & $2+2i$ & $i$    & 1      \\ \hline
            \textbf{2+2i} & $2+2i$ & $1+i$  & $1+2i$ & $i$    & 2      & $2+i$  & 1      & $2i$   \\ \hline
            \end{tabular}
        }
    \end{table}
...
\end{definition}
%TODO: Continue with the characteristic's properties
    ...
    \begin{table}[h]
        ...
        \resizebox{\textwidth}{!}{
            \begin{tabular}{|l|l|l|l|}
                \hline
                $\mathbf{\times}$   & \textbf{1} & $\mathbf{\alpha}$                 & $\mathbf{1+\alpha}$                     \\ \hline
                \textbf{1}          & 1          & $\alpha$                          & $1+\alpha$                              \\ \hline
                $\mathbf{\alpha}$   & $\alpha$   & $\alpha^2 = 1+\alpha$             & $\alpha+\alpha^2 = 1+2\alpha = 1$       \\ \hline
                $\mathbf{1+\alpha}$ & $1+\alpha$ & $\alpha+\alpha^2 = 1+2\alpha = 1$ & $1+2\alpha+\alpha^2 = 2+3\alpha=\alpha$ \\ \hline
            \end{tabular}
        }
    \end{table}
