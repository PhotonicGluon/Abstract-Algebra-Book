...
%TODO: Continue with non-examples and exercise that Z[\sqrt2] is a integral domain.
...
\begin{enumerate}
    ...
    \item \begin{enumerate}[label=(\roman*)]
        ...
        \begin{itemize}
            \item Note that $EM = \begin{pmatrix}e_1&e_2\\0&0\end{pmatrix}\begin{pmatrix}a&b\\0&0\end{pmatrix} = \begin{pmatrix}e_1a&e_1b\\0&0\end{pmatrix}$.
