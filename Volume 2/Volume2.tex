...
We look at the notion of the degree of a polynomial.
\begin{definition}
    The \textbf{degree}\index{degree} of a polynomial $a_0+a_1x+\cdots+a_nx^n$ in $R[x]$ is the largest $k$ such that $a_k \neq 0$. In this case, we write
    \[
...
\begin{exercise}\label{exercise-commutative-ring-with-identity-iff-polynomial-ring-is-also}
    Let $R$ be a ring. Prove that $R$ is a commutative ring with identity if and only if $R[x]$ is a commutative ring with identity.
