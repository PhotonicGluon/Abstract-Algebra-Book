...
\makeatletter\newcommand*{\rom}[1]{\expandafter\@slowromancap\romannumeral #1@}\makeatother  % Roman numeral
...
\def\coverpages{
  ...
  \begin{minipage}[b]{0.9\textwidth}
    ...
    This work is licensed under the Creative Commons Attribution-NonCommercial 4.0 International Licence.\par
    \includegraphics[width=2.5cm]{../Images/CC BY-NC 4.0.png}\\  % With reference to the volumes' folders
