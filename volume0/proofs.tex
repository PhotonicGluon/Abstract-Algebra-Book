...
\end{enumerate}
\begin{example}
    We prove that ``if the integer $n$ is odd then $n^2$ is odd'' using direct proof.
    \begin{proof}
        Suppose $n\in\mathbb{Z}$ is an odd number. Then $n$ can be written in the form $n = 2k + 1$ where $k$ is an integer. Hence
        \[
