...
We introduce \textbf{intervals}.
\begin{definition}
    An \textbf{interval}\index{interval} is a subset of the real numbers. In particular, if $a$ and $b$ are real numbers such that $a \leq b$, then the interval
    \begin{itemize}
