...
\externaldocument{../Volume 0/modular-arithmetic}
...
\include{basics-of-groups}
\include{subgroups}
\include{homomorphisms-and-isomorphisms}
\include{symmetry-groups}
\include{products}
\include{further-homomorphisms}
\include{more-groups}
\include{group-actions}
\include{sylow-theorems}
\include{composition-series}
\include{simple-groups}
