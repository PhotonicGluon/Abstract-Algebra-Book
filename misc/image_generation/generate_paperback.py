...
BODY_WIDTH = 5.75 * 25.4  # In mm, 5.75"
BODY_HEIGHT = 8.75 * 25.4  # In mm, 8.75"
ASPECT_RATIO = BODY_HEIGHT / BODY_WIDTH

SAFETY_MARGIN = 0.125 * 25.4  # In mm, 0.125"
TRIM_WIDTH = SAFETY_MARGIN + BODY_WIDTH + SAFETY_MARGIN  # In mm
TRIM_HEIGHT = SAFETY_MARGIN + BODY_HEIGHT + SAFETY_MARGIN  # In mm

WRAP_AREA = 0.125 * 25.4  # In mm, 0.125"
SPINE_WIDTH = NUM_PAGES * 0.00225 * 25.4
