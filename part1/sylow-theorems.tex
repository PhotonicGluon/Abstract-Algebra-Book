...
\begin{proofsketch}
    ...
    \begin{itemize}
        \item If the order of the center of $G$ is a multiple of $p$, then use Cauchy's Theorem (\myref{thrm-cauchy}) to deduce that there exists a subgroup of order $p$, say $N$. After showing $N$ is normal, conclude that $G/N$ has order $p^{k-1}m$. Use induction hypothesis on $G/N$ to produce a Sylow $p$-subgroup $\overline{S}$.
