...
\begin{wrapfigure}{r}{0.35\textwidth}
    \centering
    \pdfteximgframed{0.3\textwidth}{part1/images/triangle-reflections.pdf_tex}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.35\textwidth}
    \centering
    \pdfteximgframed{0.3\textwidth}{part1/images/circular-crossings.pdf_tex}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
    \centering
    \pdfteximgframed{0.35\textwidth}{part1/images/permutations.pdf_tex}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.325\textwidth}
    \centering
    \pdfteximgframed{0.275\textwidth}{part1/images/triangle-reflections.pdf_tex}
\end{wrapfigure}
