...
\newcommand{\vertalt}{ \ | \ }  % TODO: Check if we need this
...
\makenewresultstyle{theorem}{DarkSeaGreen2}{Green4}
\declaretheorem[name=Theorem,style=theorem-style,within=section]{theorem}
\renewcommand*{\thetheorem}{\arabic{chapter}.\arabic{section}.\arabic{theorem}}

\makenewresultstyle{lemma}{Honeydew2}{PaleTurquoise4}
...
\makenewresultstyle{corollary}{DarkSeaGreen1}{SeaGreen4}
