...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=4.5cm]{further-homomorphisms/iso-1-comm-diagram.png}}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=4.5cm]{further-homomorphisms/iso-2-subgroup-diagram.png}}
