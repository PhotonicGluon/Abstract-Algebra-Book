...
\begin{wrapfigure}{r}{0.35\textwidth}
    \centering
    \fbox{\includegraphics[width=0.3\textwidth]{chapter1/Triangle Reflections.png}}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.35\textwidth}
    \centering
    \fbox{\includegraphics[width=0.3\textwidth]{chapter1/Circular Crossings.png}}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.35\textwidth}
    \centering
    \fbox{\includegraphics[width=0.3\textwidth]{chapter1/Permutations.jpg}}
\end{wrapfigure}
